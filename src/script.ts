...
class Player extends IObject {
  ...
  constructor(pos: Vect2d, r: number, mass: number) {
...
class CollisionDetect {
  ...
  //
  static pen_res_bb(b1: IObject, b2: IObject): void {
  ...
  //
  static coll_res_bb(b1: IObject, b2: IObject): void {
  ...
  //
  static clossestPointBW(b1: IObject, w1: Wall) {
  ...
  //
  static coll_det_bw(b1: IObject, w1: Wall): boolean {
...
const WALL: Array<Wall> = new Array<Wall>()
...
const drawText = (pos: Vect2d): void => {
  ctx.fillStyle = '#fff'
